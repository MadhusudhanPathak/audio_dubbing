...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        input_layout.addWidget(self.src_lang_combo, 4, 1, 1, 2)

        # Target language selection (visible only when input type is audio or transcription)
        self.tgt_lang_label = QLabel("Target Languages:")
        self.tgt_lang_label.setToolTip("Select the language(s) to translate the audio to")

        # Create a horizontal layout for language checkboxes side-by-side
        self.tgt_lang_hlayout = QHBoxLayout()
        self.tgt_lang_hlayout.setAlignment(Qt.AlignLeft)

        # Populate language checkboxes horizontally
        self.target_language_checkboxes = []
        self.populate_language_checkboxes_horizontal()

        input_layout.addWidget(self.tgt_lang_label, 5, 0)
        input_layout.addLayout(self.tgt_lang_hlayout, 5, 1, 1, 2)
    ...
    def populate_language_combo(self, combo):
        """Populate language combo box with selected languages including English as default"""
        languages = [
            ("English", "eng_Latn"),
            ("Hindi", "hin_Deva"),
            ("Italian", "ita_Latn"),
    ...
    def populate_language_checkboxes_horizontal(self):
        """Populate language checkboxes with selected languages arranged horizontally"""
        languages = [
            ("English", "eng_Latn"),
            ("Hindi", "hin_Deva"),
            ("Italian", "ita_Latn"),
        ...
        for name, code in languages:
            ...
            self.tgt_lang_hlayout.addWidget(checkbox)
